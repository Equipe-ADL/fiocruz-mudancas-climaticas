const course = {
	title: "Curso Mudanças Climáticas e a atuação da Atenção Primária à Saúde",
	modules: [
		{
			type: "accordion",
			title: "Módulo 1: Mudanças climáticas em saúde",
			items: [
				...
				{ type: "link", icon: "lesson", title: "O papel da APS no cuidado integral à saúde e sua atuação na GRDE em Saúde", path: "/modulo1/aula4.html" },
				{ type: "link", icon: "activity", title: "Atividades", path: "/modulo1/aula1/atividades.html"},
		...
		},
		{
			...
			items: [
				...
				{ type: "link", icon: "lesson", title: "Efeitos na saúde", path: "/modulo2/aula2.html" },
				{ type: "link", icon: "lesson", title: "Atuação da APS diante destes eventos em todas as etapas GRDE em Saúde", path: "/modulo2/aula3.html" },
				{ type: "link", icon: "activity", title: "Atividades", path: "/modulo1/aula1/atividades.html"},
		...
		{
			type: "accordion",
			title: "Módulo 3: Desastres Extensivos",
			items: [
				//{ type: "link", icon: "welcome", title: "Introdução", path: "/modulo3/introducao.html" },
				{ type: "link", icon: "lesson", title: "Inundações graduais, seca e estiagens (além da crise hídrica)", path: "/modulo3/aula1.html" },
				{ type: "link", icon: "lesson", title: "Efeitos na saúde", path: "/modulo3/aula2.html" },
				{ type: "link", icon: "lesson", title: "Atuação da APS diante destes eventos em todas as etapas GRDE em Saúde", path: "/modulo3/aula3.html" },
		...
		{
			type: "accordion",
			title: "Módulo 4: Extremos de Temperatura",
			items: [
				//{ type: "link", icon: "welcome", title: "Introdução", path: "/modulo4/introducao.html" },
				{ type: "link", icon: "lesson", title: "Ondas de calor e de frio (como problema em potencial)", path: "/modulo4/aula1.html" },
				{ type: "link", icon: "lesson", title: "Efeitos na saúde", path: "/modulo4/aula2.html" },
				{ type: "link", icon: "lesson", title: "Atuação da APS diante destes eventos em todas as etapas GRDE em Saúde", path: "/modulo4/aula3.html" },
		...
		{
			type: "accordion",
			title: "Módulo 5: Eventos Intensificados pelas Mudanças Climáticas",
			items: [
				...
				{ type: "link", icon: "lesson", title: "Efeitos na saúde", path: "/modulo5/aula2.html" },
