                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse-m2-aula2" class="accordion-collapse collapse" aria-labelledby="heading-m2-aula2" data-bs-parent="">
                                        <div class="accordion-body">
                                            <div class="list mb-5">
                                                <ul class="list-group">
                                                    <li class="list-group-item aos-init aos-animate" list-style="default" data-aos="fade-right" data-aos-easing="ease-out" data-aos-duration="1200">BRASIL. Ministério do Meio Ambiente e Mudança do Clima. Ministério da Ciência, Tecnologia e Inovação. Ministério da Saúde. <em>Plano Setorial de Saúde</em> – AdaptaSUS [recurso eletrônico]. Brasília, DF: MMA; MCTI; MS, 2025. Disponível em: <a href='https://www.gov.br/saude/pt-br/centrais-deconteudo/publicacoes/cartilhas/2026/cartilha-prevencao-de-suicidios.pdf.' target='_blank' rel='noopener noreferrer'>https://www.gov.br/saude/pt-br/centrais-deconteudo/publicacoes/cartilhas/2026/cartilha-prevencao-de-suicidios.pdf.</a> Acesso em: 24 set. 2026.</li>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="list mb-5">
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item aos-init aos-animate" list-style="default" data-aos="fade-right" data-aos-easing="ease-out" data-aos-duration="1200">BRASIL. Ministério da Saúde. Vigilância em Saúde. <a href='docs/folder-orientacoes-a-populacao-em-situacao-de-enchentes.pdf' target='_blank' rel='noopener noreferrer'><em>Folder</em> - Orientações à população em situação de enchentes</a>. Brasília: Ministério da Saúde, 2026. Acesso em: 12 jul. 2026.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
